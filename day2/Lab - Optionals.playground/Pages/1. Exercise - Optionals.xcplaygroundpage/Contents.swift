...
print(userInputAge)
print("because the Int initializer returns an optional Int?")
/*:
 ...
 */
//let forcedUserAge: Int = Int(userInputAge)!
//print("Forced user age: \(forcedUserAge)")
...
//    print("User age: \(userAge)")
//} else {
//    print("Unable to convert input to age")
//}
