...
let favoriteBook = Book(title: "How to Be Happy",
                        author: "King",
                        pages: 281,
                        price: 14.99)

print("My favorite book is '\(favoriteBook.title)' by \(favoriteBook.author). " +
      "It's \(favoriteBook.pages) pages long and costs $\(favoriteBook.price). " +
...
let laptop1 = Laptop(ScreenSize: 12, repairCount: 89, yearPurchased: 0)
let laptop = Laptop(yearPurchased: 7)

print("Laptop 1 - Screen Size: \(laptop1.ScreenSize), Repair Count: \(laptop1.repairCount), Year Purchased: \(laptop1.yearPurchased)")
print("Laptop 2 - Screen Size: \(laptop.ScreenSize), Repair Count: \(laptop.repairCount), Year Purchased: \(laptop.yearPurchased)")
